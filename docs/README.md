...
![GC_ORF.png](../example_images/GC_ORF.png?raw=true "GC_ORF.png for hoxC_sequences.fa") ![seqLength_ORF.png](../example_images/seqLength_ORF.png?raw=true "seqLength_ORF.png for hoxC_sequences.fa")
